...
class Card:
    def __init__(self, attack: int, health: int, price: int, cardID: str):
        ...
        self.damage_dealt = 0  # Track total damage dealt by this card
    ...
    def clone(self):
        ...
        new_card.damage_dealt = self.damage_dealt  # Copy damage dealt
        return new_card
...
class Game:
    ...
    def attack(self, attacker_index: int, target_type: str, target_index: int = -1) -> bool:
        ...
        if target_type == "player":
            ...
            attacker.damage_dealt += attacker.attack  # Track damage to player
            return True
        ...
        if target_type == "card":
            ...
            attacker.damage_dealt += min(defender.health + attacker.attack, attacker.attack)  # Track actual damage dealt to card
